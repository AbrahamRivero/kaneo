...
The easiest way to get started with PalcoDesk is using Docker Compose. This setup includes PostgreSQL for reliable data storage:
...
PalcoDesk uses PostgreSQL for reliable data storage with proper relational integrity. The Docker Compose setup above handles this automatically, but if you're running PalcoDesk outside of Docker, you'll need to:
...
Now that you have PalcoDesk running, explore these features and deployment options:

- **[Terminology](/docs/terminology)** - Learn about PalcoDesk's core concepts and features
